window.addEventListener("load",function(){
	...
	var langDl=lang.firstElementChild;
	var langDd=langDl.lastElementChild;
	var langDt=langDl.firstElementChild;
	var langDtA=langDt.firstElementChild;
	var langUl=langDd.firstElementChild;
	var ko=document.getElementsByClassName("ko")[0];
	
	ko.addEventListener("click", function(e){
		e.preventDefault();
		if(langUl.classList.contains("active") == false){	
	...
	langDtA.addEventListener("focusin", function(){
    	setTimeout(function(){
				langUl.classList.add("active");
		}, 200);
	});
	langUl.lastElementChild.addEventListener("focusout", function(){
		langUl.classList.remove("active");
	});
